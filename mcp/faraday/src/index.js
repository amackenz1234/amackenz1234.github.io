...
server.registerTool(
  "list_categories",
  {
    ...
    description: "List Faraday product categories.",
...
server.registerTool(
  "list_products",
  {
    title: "List products",
    description:
      "List Faraday inventory. Optionally filter by category and stock.",
    inputSchema: z.object({
      category: z
        .string()
        .optional()
...
server.registerTool(
  "search_products",
  {
    ...
    description:
      "Search Faraday products by name, SKU, category, or description.",
    inputSchema: z.object({
...
server.registerTool(
  ...
  {
    title: "Get product",
    description: "Get one Faraday product by SKU.",
    inputSchema: z.object({
      sku: z.string().describe("Product SKU, e.g. FD-BANDIT"),
    }),
  },
  async ({ sku }) => {
...
server.registerTool(
  ...
  {
    title: "Get shop info",
    description: "Return Faraday contact and shop details.",
    inputSchema: z.object({}),
  },
  async () => ({
...
server.registerResource(
  ...
  {
    title: "Full catalog",
    description: "Complete Faraday product catalog as JSON",
